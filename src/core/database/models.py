...
class Account(Base):
    ...
    __table_args__ = (
        ...
        # source of truth mirrored by capabilities._DEFAULT_SUPPORTED_BILLING; the
        # two are pinned together by test_get_adcp_capabilities.TestSupportedBillingParity.
        CheckConstraint(
